...
const caseStudy = () => {
  return (
    <section className={styles.caseStudys}>
                ...
                <div className={styles.caseGrid}>
                  <div className={styles.caseCard}>
                    ...
                    <div className={styles.caseContent}>
                      <h3>Timbo App</h3>
                      <p>
                        Timbo is an app that is designed to help users
                        communicate freely via text, audio, and video calls. It
                        is private and business-friendly
                      </p>
                  ...
                  <div className={styles.caseCard}>
                    ...
                    <div className={styles.caseContent}>
                      ...
                      <p>
                        KoboFundMe is a crowdfunding app that is designed to
                        help users raise fund for their projects. The
                        application enables users to upload project
                      </p>
                      <a
                  ...
                  <div className={styles.caseCard}>
                    ...
                    <div className={styles.caseContent}>
                      <h3>KoboTree App</h3>
                      <p>
                        KoboTree is a real estate investment app that is
                        designed to help users grow their finances through
                        investment that guarantees return
                      </p>
                ...
                <div className={styles.caseGrid}>
                  <div className={styles.caseCard}>
                    ...
                    <div className={styles.caseContent}>
                      <h3>Limpkin App</h3>
                      <p>
                        Limpkin is a social media app that is designed to help
                        users share images and videos from memorable moments. It
                        is private and business-friendly
                      </p>
                  ...
                  <div className={styles.caseCard}>
                    ...
                    <div className={styles.caseContent}>
                      ...
                      <p>
                        ...
                        interested in Information Technology. Most of the
                        courses offered prepare students to
                      </p>
                      <a
